...
import com.sonnguyen.chatapp.adapters.ChatAdapter;
import com.sonnguyen.chatapp.databinding.ActivityChatBinding;
import com.sonnguyen.chatapp.models.ChatMessage;
import com.sonnguyen.chatapp.models.User;
        ...
        if (value != null) {
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    chatMessage.receiver = documentChange.getDocument().getString(Constants.KEY_RECEIVED_ID);
